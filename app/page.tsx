  ...
  return (
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
          NASA, the space agency, decided to officially build the PACE satellite to study how oceans and the air work together.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
          All the pieces of the satellite were connected and checked to make sure everything worked perfectly.
          </p>
